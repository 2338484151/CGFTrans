...
def parse_agrs():
    ...
    parser.add_argument('--dataset_name', type=str, default='iu_xray', choices=['iu_xray', 'LGK', 'mimic_cxr'],
    ...
    parser.add_argument('--num_layers_ed', type=int, default=4, help='the number of layers of Transformer.')
